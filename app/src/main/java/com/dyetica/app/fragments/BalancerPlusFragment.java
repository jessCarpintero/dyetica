...
public class BalancerPlusFragment extends Fragment {
    ...
    public static BalancerPlusFragment newInstance(String param1, String param2) {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        textView = (TextView) rootView.findViewById(R.id.balancer_text);
        textView.setText("Balancer plus");
        return rootView;
    }
